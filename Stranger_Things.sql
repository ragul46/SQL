...
SELECT C.name as Character_Name, E.event_name
FROM Relationships R
JOIN Characters C on R.character1_id = C.character_id or C.character_id = R.character2_id
...
SELECT Hometown,Count(*) No_Of_Charecter
FROM Characters
GROUP BY Hometown;
